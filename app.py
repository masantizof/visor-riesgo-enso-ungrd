...
=================================
Entrypoint del visor. Muestra el semáforo con la fase ENSO vigente (ONI),
su intensidad y la teleconexión esperada para Colombia, junto con el mapa
nacional de riesgo amplificado por esa fase (cruce ENSO × índices SNGRD).

La app NUNCA consulta IDEAM/NOAA en vivo: todo proviene de los snapshots
en data_lake/ (ver src/loaders.py).
"""
import streamlit as st

from src import loaders, ui
from src.maps import capa_vector_coloreada, mapa_base, mostrar_mapa, agregar_leyenda
from src.downloads import boton_csv, boton_geojson
